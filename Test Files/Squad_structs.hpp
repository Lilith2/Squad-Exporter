...
enum class EGuidanceLossReason : uint8
{
	...
	BlockedByCountermeasures                 = 9,
	Invalid                                  = 10,
	AnyReason                                = 11,
	EGuidanceLossReason_MAX                  = 12,
};

// Enum Squad.ESQObjectiveTypeFilter
// NumValues: 0x0005
enum class ESQObjectiveTypeFilter : uint8
{
	None                                     = 0,
	Attack                                   = 1,
	Defense                                  = 2,
	DefenseAndNeutral                        = 3,
	ESQObjectiveTypeFilter_MAX               = 4,
};
...
// Enum Squad.ELocalChatModes
// NumValues: 0x0005
enum class ELocalChatModes : uint8
{
	HearFriendly_HeardByFriendly             = 0,
	HearAll_HeardByFriendly                  = 1,
	HearAll_HeardByAll                       = 2,
	HearAll_HeardByEnemy                     = 3,
	MAX                                      = 4,
};
...
// Enum Squad.ESQCalculationSource
// NumValues: 0x0003
enum class ESQCalculationSource : uint8
{
	Score                                    = 0,
	Stat                                     = 1,
	ESQCalculationSource_MAX                 = 2,
};

// Enum Squad.ESQPlayerCalloutType
// NumValues: 0x0003
enum class ESQPlayerCalloutType : uint8
{
	Player                                   = 0,
	Squad                                    = 1,
	ESQPlayerCalloutType_MAX                 = 2,
};
...
// Enum Squad.ESQTimelineInterpolation
// NumValues: 0x0003
enum class ESQTimelineInterpolation : uint8
{
	Straight                                 = 0,
	Step                                     = 1,
	ESQTimelineInterpolation_MAX             = 2,
};

// Enum Squad.ESQTicketChangeReason
// NumValues: 0x0013
enum class ESQTicketChangeReason : uint8
{
	Unknown                                  = 0,
	Death                                    = 1,
	Suicide                                  = 2,
	...
	LostObjective                            = 13,
	GainedObjective                          = 14,
	InitialGainedObjective                   = 15,
	TicketBleed                              = 16,
	MatchStart                               = 17,
	ESQTicketChangeReason_MAX                = 18,
};

// Enum Squad.ESQStatsType
// NumValues: 0x001D
enum class ESQStatsType : uint8
{
	Revives                                  = 0,
	Healing                                  = 1,
	DriverAssistKills                        = 2,
	DriverObjectivesTransport                = 3,
	PlacedSupportRequests                    = 4,
	SentTacticalSupport                      = 5,
	TEAMWORK_END                             = 6,
	Incapacitations                          = 7,
	Kills                                    = 8,
	VehicleKills                             = 9,
	...
	DamageInflicted                          = 12,
	VehicleDamage                            = 13,
	SuppressionInflicted                     = 14,
	SuppressionReceived                      = 15,
	FOBDestroy                               = 16,
	COMBAT_END                               = 17,
	ObjectiveCaptureTick                     = 18,
	ObjectiveDefenseTick                     = 19,
	ObjectiveDefense                         = 20,
	ObjectiveNeutralize                      = 21,
	ObjectiveCapture                         = 22,
	OBJECTIVE_END                            = 23,
	FOBCreated                               = 24,
	AmmoSupplied                             = 25,
	ConstructionSupplied                     = 26,
	LOGISTICS_END                            = 27,
	ESQStatsType_MAX                         = 28,
};

// Enum Squad.ESQScoreType
// NumValues: 0x0005
enum class ESQScoreType : uint8
{
	None                                     = 0,
	Teamwork                                 = 1,
	Objective                                = 2,
...
// Enum Squad.ESQWeaponInterpState
// NumValues: 0x0006
enum class ESQWeaponInterpState : uint8
{
	None                                     = 0,
	ToSoldier                                = 1,
	ToWeapon                                 = 2,
...
// ScriptStruct Squad.SQTeamworkStat
// 0x0028 (0x0028 - 0x0000)
struct alignas(0x08) FSQTeamworkStat final
{
public:
	uint8                                         Pad_0[0x28];                                       // 0x0000(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQTeamworkStat) == 0x000008, "Wrong alignment on FSQTeamworkStat");
static_assert(sizeof(FSQTeamworkStat) == 0x000028, "Wrong size on FSQTeamworkStat");
...
public:
	...
	uint8                                         Pad_7E[0xA];                                       // 0x007E(0x000A)(Fixing Size After Last Property [ Dumper-7 ])
...
// ScriptStruct Squad.SQTimelineElement
// 0x0010 (0x0010 - 0x0000)
struct FSQTimelineElement final
{
public:
	class UUserWidget*                            WidgetRef;                                         // 0x0000(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              ScaledPosition;                                    // 0x0008(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQTimelineElement) == 0x000008, "Wrong alignment on FSQTimelineElement");
static_assert(sizeof(FSQTimelineElement) == 0x000010, "Wrong size on FSQTimelineElement");
static_assert(offsetof(FSQTimelineElement, WidgetRef) == 0x000000, "Member 'FSQTimelineElement::WidgetRef' has a wrong offset!");
static_assert(offsetof(FSQTimelineElement, ScaledPosition) == 0x000008, "Member 'FSQTimelineElement::ScaledPosition' has a wrong offset!");
...
public:
	...
	bool                                          bFlingableSeat;                                    // 0x0003(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowOrientationBasedFlinging;                    // 0x0004(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         FlingRollAngleThreshold;                           // 0x0008(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FlingPitchAngleThreshold;                          // 0x000C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowAccelerationBasedFlinging;                   // 0x0010(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         EjectionThresholdGs;                               // 0x0014(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinimumSpeedToFling;                               // 0x0018(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SeatHealth;                                        // 0x001C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxRepairToolLimit;                                // 0x0020(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPassDamageToVehicle;                              // 0x0024(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CollisionDamageMultipler;                          // 0x0028(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPassPointDamageToVehicle;                         // 0x002C(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSoldierCanTakeDirectRadialDamage;                 // 0x002D(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPassRadialDamageToVehicle;                        // 0x002E(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2F[0x1];                                       // 0x002F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SeatAttachSocket;                                  // 0x0030(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SoldierAttachSocket;                               // 0x0038(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ASQVehicleSeat>             SeatPawn;                                          // 0x0040(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         InitialState;                                      // 0x0048(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FSQVehicleSeatState>            SeatStates;                                        // 0x0050(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
	bool                                          bShouldAlwaysStayRegistered;                       // 0x0060(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSoldierInSeatCanCapture;                          // 0x0061(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseRotationComponentForControlRotation;           // 0x0062(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_63[0x1];                                       // 0x0063(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         EnterSeatDuration;                                 // 0x0064(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SuppressionMultiplier;                             // 0x0068(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxSuppressionLevel;                               // 0x006C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQVehicleSeatConfig) == 0x000008, "Wrong alignment on FSQVehicleSeatConfig");
static_assert(sizeof(FSQVehicleSeatConfig) == 0x000070, "Wrong size on FSQVehicleSeatConfig");
...
static_assert(offsetof(FSQVehicleSeatConfig, bFlingableSeat) == 0x000003, "Member 'FSQVehicleSeatConfig::bFlingableSeat' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, bAllowOrientationBasedFlinging) == 0x000004, "Member 'FSQVehicleSeatConfig::bAllowOrientationBasedFlinging' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, FlingRollAngleThreshold) == 0x000008, "Member 'FSQVehicleSeatConfig::FlingRollAngleThreshold' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, FlingPitchAngleThreshold) == 0x00000C, "Member 'FSQVehicleSeatConfig::FlingPitchAngleThreshold' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, bAllowAccelerationBasedFlinging) == 0x000010, "Member 'FSQVehicleSeatConfig::bAllowAccelerationBasedFlinging' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, EjectionThresholdGs) == 0x000014, "Member 'FSQVehicleSeatConfig::EjectionThresholdGs' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, MinimumSpeedToFling) == 0x000018, "Member 'FSQVehicleSeatConfig::MinimumSpeedToFling' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, SeatHealth) == 0x00001C, "Member 'FSQVehicleSeatConfig::SeatHealth' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, MaxRepairToolLimit) == 0x000020, "Member 'FSQVehicleSeatConfig::MaxRepairToolLimit' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, bPassDamageToVehicle) == 0x000024, "Member 'FSQVehicleSeatConfig::bPassDamageToVehicle' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, CollisionDamageMultipler) == 0x000028, "Member 'FSQVehicleSeatConfig::CollisionDamageMultipler' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, bPassPointDamageToVehicle) == 0x00002C, "Member 'FSQVehicleSeatConfig::bPassPointDamageToVehicle' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, bSoldierCanTakeDirectRadialDamage) == 0x00002D, "Member 'FSQVehicleSeatConfig::bSoldierCanTakeDirectRadialDamage' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, bPassRadialDamageToVehicle) == 0x00002E, "Member 'FSQVehicleSeatConfig::bPassRadialDamageToVehicle' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, SeatAttachSocket) == 0x000030, "Member 'FSQVehicleSeatConfig::SeatAttachSocket' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, SoldierAttachSocket) == 0x000038, "Member 'FSQVehicleSeatConfig::SoldierAttachSocket' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, SeatPawn) == 0x000040, "Member 'FSQVehicleSeatConfig::SeatPawn' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, InitialState) == 0x000048, "Member 'FSQVehicleSeatConfig::InitialState' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, SeatStates) == 0x000050, "Member 'FSQVehicleSeatConfig::SeatStates' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, bShouldAlwaysStayRegistered) == 0x000060, "Member 'FSQVehicleSeatConfig::bShouldAlwaysStayRegistered' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, bSoldierInSeatCanCapture) == 0x000061, "Member 'FSQVehicleSeatConfig::bSoldierInSeatCanCapture' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, bUseRotationComponentForControlRotation) == 0x000062, "Member 'FSQVehicleSeatConfig::bUseRotationComponentForControlRotation' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, EnterSeatDuration) == 0x000064, "Member 'FSQVehicleSeatConfig::EnterSeatDuration' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, SuppressionMultiplier) == 0x000068, "Member 'FSQVehicleSeatConfig::SuppressionMultiplier' has a wrong offset!");
static_assert(offsetof(FSQVehicleSeatConfig, MaxSuppressionLevel) == 0x00006C, "Member 'FSQVehicleSeatConfig::MaxSuppressionLevel' has a wrong offset!");
...
// ScriptStruct Squad.SQTimelinePointElement
// 0x0018 (0x0018 - 0x0000)
struct FSQTimelinePointElement final
{
public:
	class USQTimelinePoint*                       WidgetRef;                                         // 0x0000(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              ScaledPosition;                                    // 0x0008(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              ViewportPosition;                                  // 0x0010(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQTimelinePointElement) == 0x000008, "Wrong alignment on FSQTimelinePointElement");
static_assert(sizeof(FSQTimelinePointElement) == 0x000018, "Wrong size on FSQTimelinePointElement");
static_assert(offsetof(FSQTimelinePointElement, WidgetRef) == 0x000000, "Member 'FSQTimelinePointElement::WidgetRef' has a wrong offset!");
static_assert(offsetof(FSQTimelinePointElement, ScaledPosition) == 0x000008, "Member 'FSQTimelinePointElement::ScaledPosition' has a wrong offset!");
static_assert(offsetof(FSQTimelinePointElement, ViewportPosition) == 0x000010, "Member 'FSQTimelinePointElement::ViewportPosition' has a wrong offset!");
...
public:
	...
	uint8                                         bLoopMuzzleFlash : 1;                              // 0x0040(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bLoopShellEjection : 1;                            // 0x0040(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_41[0x3];                                       // 0x0041(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   MuzzleFlashSocket;                                 // 0x0044(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   ShellEjectionSocket;                               // 0x004C(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ShellEjectionCullDistanceInMeters;                 // 0x0054(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FSQWeaponEffects, MuzzleFlashSocket) == 0x000044, "Member 'FSQWeaponEffects::MuzzleFlashSocket' has a wrong offset!");
static_assert(offsetof(FSQWeaponEffects, ShellEjectionSocket) == 0x00004C, "Member 'FSQWeaponEffects::ShellEjectionSocket' has a wrong offset!");
static_assert(offsetof(FSQWeaponEffects, ShellEjectionCullDistanceInMeters) == 0x000054, "Member 'FSQWeaponEffects::ShellEjectionCullDistanceInMeters' has a wrong offset!");
...
public:
	...
	int32                                         TimeBetweenMatches;                                // 0x0070(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TimeBeforeVote;                                    // 0x0074(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_78[0x3];                                       // 0x0078(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bTKAutoKickEnabled;                                // 0x007B(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7C[0x4];                                       // 0x007C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 MessageOfTheDay;                                   // 0x0080(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, RepSkip, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESQMapRotationMode                            MapRotationMode;                                   // 0x0090(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          RandomizeAtStart;                                  // 0x0091(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          UseVoteFactions;                                   // 0x0092(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          UseVoteLevel;                                      // 0x0093(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          UseVoteLayer;                                      // 0x0094(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_95[0xB];                                       // 0x0095(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         LayerVotingTime;                                   // 0x00A0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         FactionVotingTime;                                 // 0x00A4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LayerOptionsNumber;                                // 0x00A8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         FactionOptionsNumber;                              // 0x00AC(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MapSkipRounds;                                     // 0x00B0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MapBiomeSkipRounds;                                // 0x00B4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LayerSizeSkipRounds;                               // 0x00B8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_BC[0xA4];                                      // 0x00BC(0x00A4)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         LayerSkipRounds;                                   // 0x0160(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         FactionSkipRounds;                                 // 0x0164(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         FactionSetupSkipRounds;                            // 0x0168(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LowPlayerCountThreshold;                           // 0x016C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDisplayVotes;                                     // 0x0170(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDisplayVoteEnemyInfo;                             // 0x0171(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSymmetricalMatchUp;                               // 0x0172(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUniqueMapVote;                                    // 0x0173(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoSelectFactions;                               // 0x0174(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_175[0x3];                                      // 0x0175(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 StartupLayer;                                      // 0x0178(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           ServerTags;                                        // 0x0188(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           LevelRotation;                                     // 0x0198(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         LayerVoteList;                                     // 0x01A8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         LayerRotation;                                     // 0x01B8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         LayerRotationLowPlayers;                           // 0x01C8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           ExcludedFactions;                                  // 0x01D8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           ExcludedFactionTypes;                              // 0x01E8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           ExcludedFactionSetups;                             // 0x01F8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           ExcludedLevels;                                    // 0x0208(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           ExcludedLayers;                                    // 0x0218(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FSQCustomSettings                      CustomOptions;                                     // 0x0228(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	int32                                         LevelCountPerVote;                                 // 0x0248(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24C[0x4];                                      // 0x024C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSQVoteConfig                          LevelVoteConfig;                                   // 0x0250(0x0040)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	int32                                         LayerCountPerVote;                                 // 0x0290(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_294[0x4];                                      // 0x0294(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSQVoteConfig                          LayerVoteConfig;                                   // 0x0298(0x0040)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TArray<struct FSQVoteConfig>                  FactionVoteConfigs;                                // 0x02D8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         JoiningPlayerTimeout;                              // 0x02E8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FSQServerSettings) == 0x0002F0, "Wrong size on FSQServerSettings");
...
static_assert(offsetof(FSQServerSettings, TimeBetweenMatches) == 0x000070, "Member 'FSQServerSettings::TimeBetweenMatches' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, TimeBeforeVote) == 0x000074, "Member 'FSQServerSettings::TimeBeforeVote' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, bTKAutoKickEnabled) == 0x00007B, "Member 'FSQServerSettings::bTKAutoKickEnabled' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, MessageOfTheDay) == 0x000080, "Member 'FSQServerSettings::MessageOfTheDay' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, MapRotationMode) == 0x000090, "Member 'FSQServerSettings::MapRotationMode' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, RandomizeAtStart) == 0x000091, "Member 'FSQServerSettings::RandomizeAtStart' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, UseVoteFactions) == 0x000092, "Member 'FSQServerSettings::UseVoteFactions' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, UseVoteLevel) == 0x000093, "Member 'FSQServerSettings::UseVoteLevel' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, UseVoteLayer) == 0x000094, "Member 'FSQServerSettings::UseVoteLayer' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LayerVotingTime) == 0x0000A0, "Member 'FSQServerSettings::LayerVotingTime' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, FactionVotingTime) == 0x0000A4, "Member 'FSQServerSettings::FactionVotingTime' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LayerOptionsNumber) == 0x0000A8, "Member 'FSQServerSettings::LayerOptionsNumber' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, FactionOptionsNumber) == 0x0000AC, "Member 'FSQServerSettings::FactionOptionsNumber' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, MapSkipRounds) == 0x0000B0, "Member 'FSQServerSettings::MapSkipRounds' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, MapBiomeSkipRounds) == 0x0000B4, "Member 'FSQServerSettings::MapBiomeSkipRounds' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LayerSizeSkipRounds) == 0x0000B8, "Member 'FSQServerSettings::LayerSizeSkipRounds' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LayerSkipRounds) == 0x000160, "Member 'FSQServerSettings::LayerSkipRounds' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, FactionSkipRounds) == 0x000164, "Member 'FSQServerSettings::FactionSkipRounds' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, FactionSetupSkipRounds) == 0x000168, "Member 'FSQServerSettings::FactionSetupSkipRounds' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LowPlayerCountThreshold) == 0x00016C, "Member 'FSQServerSettings::LowPlayerCountThreshold' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, bDisplayVotes) == 0x000170, "Member 'FSQServerSettings::bDisplayVotes' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, bDisplayVoteEnemyInfo) == 0x000171, "Member 'FSQServerSettings::bDisplayVoteEnemyInfo' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, bSymmetricalMatchUp) == 0x000172, "Member 'FSQServerSettings::bSymmetricalMatchUp' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, bUniqueMapVote) == 0x000173, "Member 'FSQServerSettings::bUniqueMapVote' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, bAutoSelectFactions) == 0x000174, "Member 'FSQServerSettings::bAutoSelectFactions' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, StartupLayer) == 0x000178, "Member 'FSQServerSettings::StartupLayer' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, ServerTags) == 0x000188, "Member 'FSQServerSettings::ServerTags' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LevelRotation) == 0x000198, "Member 'FSQServerSettings::LevelRotation' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LayerVoteList) == 0x0001A8, "Member 'FSQServerSettings::LayerVoteList' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LayerRotation) == 0x0001B8, "Member 'FSQServerSettings::LayerRotation' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LayerRotationLowPlayers) == 0x0001C8, "Member 'FSQServerSettings::LayerRotationLowPlayers' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, ExcludedFactions) == 0x0001D8, "Member 'FSQServerSettings::ExcludedFactions' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, ExcludedFactionTypes) == 0x0001E8, "Member 'FSQServerSettings::ExcludedFactionTypes' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, ExcludedFactionSetups) == 0x0001F8, "Member 'FSQServerSettings::ExcludedFactionSetups' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, ExcludedLevels) == 0x000208, "Member 'FSQServerSettings::ExcludedLevels' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, ExcludedLayers) == 0x000218, "Member 'FSQServerSettings::ExcludedLayers' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, CustomOptions) == 0x000228, "Member 'FSQServerSettings::CustomOptions' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LevelCountPerVote) == 0x000248, "Member 'FSQServerSettings::LevelCountPerVote' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LevelVoteConfig) == 0x000250, "Member 'FSQServerSettings::LevelVoteConfig' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LayerCountPerVote) == 0x000290, "Member 'FSQServerSettings::LayerCountPerVote' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, LayerVoteConfig) == 0x000298, "Member 'FSQServerSettings::LayerVoteConfig' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, FactionVoteConfigs) == 0x0002D8, "Member 'FSQServerSettings::FactionVoteConfigs' has a wrong offset!");
static_assert(offsetof(FSQServerSettings, JoiningPlayerTimeout) == 0x0002E8, "Member 'FSQServerSettings::JoiningPlayerTimeout' has a wrong offset!");
...
// ScriptStruct Squad.SQTicketsSummaryRecord
// 0x000C (0x000C - 0x0000)
struct FSQTicketsSummaryRecord
{
public:
	ESQTicketChangeReason                         StatType;                                          // 0x0000(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Units;                                             // 0x0004(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         UnitTicketValue;                                   // 0x0008(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQTicketsSummaryRecord) == 0x000004, "Wrong alignment on FSQTicketsSummaryRecord");
static_assert(sizeof(FSQTicketsSummaryRecord) == 0x00000C, "Wrong size on FSQTicketsSummaryRecord");
static_assert(offsetof(FSQTicketsSummaryRecord, StatType) == 0x000000, "Member 'FSQTicketsSummaryRecord::StatType' has a wrong offset!");
static_assert(offsetof(FSQTicketsSummaryRecord, Units) == 0x000004, "Member 'FSQTicketsSummaryRecord::Units' has a wrong offset!");
static_assert(offsetof(FSQTicketsSummaryRecord, UnitTicketValue) == 0x000008, "Member 'FSQTicketsSummaryRecord::UnitTicketValue' has a wrong offset!");

// ScriptStruct Squad.SQTicketsSummaryVehicleRecord
// 0x000C (0x0018 - 0x000C)
struct FSQTicketsSummaryVehicleRecord final : public FSQTicketsSummaryRecord
{
public:
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class USQVehicleSettings*                     VehicleData;                                       // 0x0010(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQTicketsSummaryVehicleRecord) == 0x000008, "Wrong alignment on FSQTicketsSummaryVehicleRecord");
static_assert(sizeof(FSQTicketsSummaryVehicleRecord) == 0x000018, "Wrong size on FSQTicketsSummaryVehicleRecord");
static_assert(offsetof(FSQTicketsSummaryVehicleRecord, VehicleData) == 0x000010, "Member 'FSQTicketsSummaryVehicleRecord::VehicleData' has a wrong offset!");
...
public:
	int32                                         SquadId;                                           // 0x0000(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         FireTeamId;                                        // 0x0004(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESQAuthorityTypes                             LeaderState;                                       // 0x0008(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USQRoleSettings*                        CurrentRole;                                       // 0x0010(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	bool                                          bUseProps;                                         // 0x0000(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseRandomEmotes;                                  // 0x0001(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2[0x6];                                        // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FSQEmotePropData                       PreviewProp;                                       // 0x0038(0x0060)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FSQEmotePropData                       EmotePropInformation;                              // 0x0098(0x0060)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FEmoteAnimationData) == 0x000008, "Wrong alignment on FEmoteAnimationData");
static_assert(sizeof(FEmoteAnimationData) == 0x0000F8, "Wrong size on FEmoteAnimationData");
static_assert(offsetof(FEmoteAnimationData, bUseProps) == 0x000000, "Member 'FEmoteAnimationData::bUseProps' has a wrong offset!");
static_assert(offsetof(FEmoteAnimationData, bUseRandomEmotes) == 0x000001, "Member 'FEmoteAnimationData::bUseRandomEmotes' has a wrong offset!");
...
static_assert(offsetof(FEmoteAnimationData, PreviewProp) == 0x000038, "Member 'FEmoteAnimationData::PreviewProp' has a wrong offset!");
static_assert(offsetof(FEmoteAnimationData, EmotePropInformation) == 0x000098, "Member 'FEmoteAnimationData::EmotePropInformation' has a wrong offset!");

// ScriptStruct Squad.SQTeamTicketChange
// 0x0010 (0x0010 - 0x0000)
struct alignas(0x08) FSQTeamTicketChange final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQTeamTicketChange) == 0x000008, "Wrong alignment on FSQTeamTicketChange");
static_assert(sizeof(FSQTeamTicketChange) == 0x000010, "Wrong size on FSQTeamTicketChange");
...
// ScriptStruct Squad.SQScoringSetting
// 0x000C (0x000C - 0x0000)
struct FSQScoringSetting final
{
public:
	ESQScoreType                                  Type;                                              // 0x0000(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Points;                                            // 0x0004(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDelayedScore;                                     // 0x0008(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9[0x3];                                        // 0x0009(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQScoringSetting) == 0x000004, "Wrong alignment on FSQScoringSetting");
static_assert(sizeof(FSQScoringSetting) == 0x00000C, "Wrong size on FSQScoringSetting");
static_assert(offsetof(FSQScoringSetting, Type) == 0x000000, "Member 'FSQScoringSetting::Type' has a wrong offset!");
static_assert(offsetof(FSQScoringSetting, Points) == 0x000004, "Member 'FSQScoringSetting::Points' has a wrong offset!");
static_assert(offsetof(FSQScoringSetting, bDelayedScore) == 0x000008, "Member 'FSQScoringSetting::bDelayedScore' has a wrong offset!");
...
{
public:
	struct FSQScoringSetting                      PointsForFlagNeutralize;                           // 0x0000(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForCapture;                                  // 0x000C(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForDefense;                                  // 0x0018(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsOnCaptureTick;                               // 0x0024(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsOnDefenseTick;                               // 0x0030(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	ESQKillReportChannel                          CaptureReportChannel;                              // 0x003C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESQKillReportChannel                          NeutralizeReportChannel;                           // 0x003D(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESQKillReportChannel                          DefenseReportChannel;                              // 0x003E(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bNotifyPlayerOnNeutral;                            // 0x003F(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bNotifyPlayerOnCapture;                            // 0x0040(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bNotifyPlayerOnDefense;                            // 0x0041(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bNotifyPlayerOnTick;                               // 0x0042(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FSQFlagScoreInfo) == 0x000044, "Wrong size on FSQFlagScoreInfo");
static_assert(offsetof(FSQFlagScoreInfo, PointsForFlagNeutralize) == 0x000000, "Member 'FSQFlagScoreInfo::PointsForFlagNeutralize' has a wrong offset!");
static_assert(offsetof(FSQFlagScoreInfo, PointsForCapture) == 0x00000C, "Member 'FSQFlagScoreInfo::PointsForCapture' has a wrong offset!");
static_assert(offsetof(FSQFlagScoreInfo, PointsForDefense) == 0x000018, "Member 'FSQFlagScoreInfo::PointsForDefense' has a wrong offset!");
static_assert(offsetof(FSQFlagScoreInfo, PointsOnCaptureTick) == 0x000024, "Member 'FSQFlagScoreInfo::PointsOnCaptureTick' has a wrong offset!");
static_assert(offsetof(FSQFlagScoreInfo, PointsOnDefenseTick) == 0x000030, "Member 'FSQFlagScoreInfo::PointsOnDefenseTick' has a wrong offset!");
static_assert(offsetof(FSQFlagScoreInfo, CaptureReportChannel) == 0x00003C, "Member 'FSQFlagScoreInfo::CaptureReportChannel' has a wrong offset!");
static_assert(offsetof(FSQFlagScoreInfo, NeutralizeReportChannel) == 0x00003D, "Member 'FSQFlagScoreInfo::NeutralizeReportChannel' has a wrong offset!");
static_assert(offsetof(FSQFlagScoreInfo, DefenseReportChannel) == 0x00003E, "Member 'FSQFlagScoreInfo::DefenseReportChannel' has a wrong offset!");
static_assert(offsetof(FSQFlagScoreInfo, bNotifyPlayerOnNeutral) == 0x00003F, "Member 'FSQFlagScoreInfo::bNotifyPlayerOnNeutral' has a wrong offset!");
static_assert(offsetof(FSQFlagScoreInfo, bNotifyPlayerOnCapture) == 0x000040, "Member 'FSQFlagScoreInfo::bNotifyPlayerOnCapture' has a wrong offset!");
static_assert(offsetof(FSQFlagScoreInfo, bNotifyPlayerOnDefense) == 0x000041, "Member 'FSQFlagScoreInfo::bNotifyPlayerOnDefense' has a wrong offset!");
static_assert(offsetof(FSQFlagScoreInfo, bNotifyPlayerOnTick) == 0x000042, "Member 'FSQFlagScoreInfo::bNotifyPlayerOnTick' has a wrong offset!");
...
// ScriptStruct Squad.GuidanceLossBehaviour
// 0x000C (0x000C - 0x0000)
struct FGuidanceLossBehaviour final
{
public:
	EGuidanceLossBehaviour                        Behaviour;                                         // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         NewMovementModeIndex;                              // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TimeBeforeDetonationAfterGuidanceLoss;             // 0x0008(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGuidanceLossBehaviour) == 0x000004, "Wrong alignment on FGuidanceLossBehaviour");
static_assert(sizeof(FGuidanceLossBehaviour) == 0x00000C, "Wrong size on FGuidanceLossBehaviour");
static_assert(offsetof(FGuidanceLossBehaviour, Behaviour) == 0x000000, "Member 'FGuidanceLossBehaviour::Behaviour' has a wrong offset!");
static_assert(offsetof(FGuidanceLossBehaviour, NewMovementModeIndex) == 0x000004, "Member 'FGuidanceLossBehaviour::NewMovementModeIndex' has a wrong offset!");
static_assert(offsetof(FGuidanceLossBehaviour, TimeBeforeDetonationAfterGuidanceLoss) == 0x000008, "Member 'FGuidanceLossBehaviour::TimeBeforeDetonationAfterGuidanceLoss' has a wrong offset!");
...
public:
	...
	struct FSQScoringSetting                      PointsForHealScore;                                // 0x0010(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	float                                         PointsForSelfHeal;                                 // 0x001C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForSelfHealScore;                            // 0x0020(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	float                                         TeamPointsForRevive;                               // 0x002C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      TeamPointsForReviveScore;                          // 0x0030(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	float                                         TeamPointsForHeal;                                 // 0x003C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TeamPointsForSelfHeal;                             // 0x0040(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DelayHealScore;                                    // 0x0044(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DelaySelfHealScore;                                // 0x0045(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FSQHealSettings) == 0x000048, "Wrong size on FSQHealSettings");
...
static_assert(offsetof(FSQHealSettings, PointsForHealScore) == 0x000010, "Member 'FSQHealSettings::PointsForHealScore' has a wrong offset!");
static_assert(offsetof(FSQHealSettings, PointsForSelfHeal) == 0x00001C, "Member 'FSQHealSettings::PointsForSelfHeal' has a wrong offset!");
static_assert(offsetof(FSQHealSettings, PointsForSelfHealScore) == 0x000020, "Member 'FSQHealSettings::PointsForSelfHealScore' has a wrong offset!");
static_assert(offsetof(FSQHealSettings, TeamPointsForRevive) == 0x00002C, "Member 'FSQHealSettings::TeamPointsForRevive' has a wrong offset!");
static_assert(offsetof(FSQHealSettings, TeamPointsForReviveScore) == 0x000030, "Member 'FSQHealSettings::TeamPointsForReviveScore' has a wrong offset!");
static_assert(offsetof(FSQHealSettings, TeamPointsForHeal) == 0x00003C, "Member 'FSQHealSettings::TeamPointsForHeal' has a wrong offset!");
static_assert(offsetof(FSQHealSettings, TeamPointsForSelfHeal) == 0x000040, "Member 'FSQHealSettings::TeamPointsForSelfHeal' has a wrong offset!");
static_assert(offsetof(FSQHealSettings, DelayHealScore) == 0x000044, "Member 'FSQHealSettings::DelayHealScore' has a wrong offset!");
static_assert(offsetof(FSQHealSettings, DelaySelfHealScore) == 0x000045, "Member 'FSQHealSettings::DelaySelfHealScore' has a wrong offset!");
...
public:
	...
	struct FSQScoringSetting                      PointsForKillScore;                                // 0x001C(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForWoundedScore;                             // 0x0028(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForSuicideScore;                             // 0x0034(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForTeamkillScore;                            // 0x0040(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForVictimIncapScore;                         // 0x004C(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForDeathScore;                               // 0x0058(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForDamageScore;                              // 0x0064(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForVehicleDamageScore;                       // 0x0070(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForSuppressionInflictedScore;                // 0x007C(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForSuppressionReceivedScore;                 // 0x0088(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      NoDeathBonusScore;                                 // 0x0094(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	ESQScoreType                                  DriverKillAssistScoreType;                         // 0x00A0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDriverKillAssistDelayed;                          // 0x00A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A2[0x2];                                       // 0x00A2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TeamPointsForSuicide;                              // 0x00A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          NotifyKillerOnKill;                                // 0x00A8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          NotifyKillerOnTeamkill;                            // 0x00A9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_AA[0x2];                                       // 0x00AA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         NoDeathBonusMinGameTime;                           // 0x00AC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DelayKillScore;                                    // 0x00B0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DelayTeamkillScore;                                // 0x00B1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DelayDeathScore;                                   // 0x00B2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FSQKillDeathSettings) == 0x0000B4, "Wrong size on FSQKillDeathSettings");
...
static_assert(offsetof(FSQKillDeathSettings, PointsForKillScore) == 0x00001C, "Member 'FSQKillDeathSettings::PointsForKillScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, PointsForWoundedScore) == 0x000028, "Member 'FSQKillDeathSettings::PointsForWoundedScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, PointsForSuicideScore) == 0x000034, "Member 'FSQKillDeathSettings::PointsForSuicideScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, PointsForTeamkillScore) == 0x000040, "Member 'FSQKillDeathSettings::PointsForTeamkillScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, PointsForVictimIncapScore) == 0x00004C, "Member 'FSQKillDeathSettings::PointsForVictimIncapScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, PointsForDeathScore) == 0x000058, "Member 'FSQKillDeathSettings::PointsForDeathScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, PointsForDamageScore) == 0x000064, "Member 'FSQKillDeathSettings::PointsForDamageScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, PointsForVehicleDamageScore) == 0x000070, "Member 'FSQKillDeathSettings::PointsForVehicleDamageScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, PointsForSuppressionInflictedScore) == 0x00007C, "Member 'FSQKillDeathSettings::PointsForSuppressionInflictedScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, PointsForSuppressionReceivedScore) == 0x000088, "Member 'FSQKillDeathSettings::PointsForSuppressionReceivedScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, NoDeathBonusScore) == 0x000094, "Member 'FSQKillDeathSettings::NoDeathBonusScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, DriverKillAssistScoreType) == 0x0000A0, "Member 'FSQKillDeathSettings::DriverKillAssistScoreType' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, bDriverKillAssistDelayed) == 0x0000A1, "Member 'FSQKillDeathSettings::bDriverKillAssistDelayed' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, TeamPointsForSuicide) == 0x0000A4, "Member 'FSQKillDeathSettings::TeamPointsForSuicide' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, NotifyKillerOnKill) == 0x0000A8, "Member 'FSQKillDeathSettings::NotifyKillerOnKill' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, NotifyKillerOnTeamkill) == 0x0000A9, "Member 'FSQKillDeathSettings::NotifyKillerOnTeamkill' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, NoDeathBonusMinGameTime) == 0x0000AC, "Member 'FSQKillDeathSettings::NoDeathBonusMinGameTime' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, DelayKillScore) == 0x0000B0, "Member 'FSQKillDeathSettings::DelayKillScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, DelayTeamkillScore) == 0x0000B1, "Member 'FSQKillDeathSettings::DelayTeamkillScore' has a wrong offset!");
static_assert(offsetof(FSQKillDeathSettings, DelayDeathScore) == 0x0000B2, "Member 'FSQKillDeathSettings::DelayDeathScore' has a wrong offset!");
...
{
public:
	struct FSQScoringSetting                      PointsForAmmoDelivered;                            // 0x0000(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForConstructionDelivered;                    // 0x000C(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	float                                         PassengerPercent;                                  // 0x0018(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQLogisticsSettings) == 0x000004, "Wrong alignment on FSQLogisticsSettings");
static_assert(sizeof(FSQLogisticsSettings) == 0x00001C, "Wrong size on FSQLogisticsSettings");
static_assert(offsetof(FSQLogisticsSettings, PointsForAmmoDelivered) == 0x000000, "Member 'FSQLogisticsSettings::PointsForAmmoDelivered' has a wrong offset!");
static_assert(offsetof(FSQLogisticsSettings, PointsForConstructionDelivered) == 0x00000C, "Member 'FSQLogisticsSettings::PointsForConstructionDelivered' has a wrong offset!");
static_assert(offsetof(FSQLogisticsSettings, PassengerPercent) == 0x000018, "Member 'FSQLogisticsSettings::PassengerPercent' has a wrong offset!");
...
// ScriptStruct Squad.SQTeamworkSettings
// 0x002C (0x002C - 0x0000)
struct FSQTeamworkSettings final
{
public:
	struct FSQScoringSetting                      PointsForApprovedMarker;                           // 0x0000(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PointsForSendingTacticalSupport;                   // 0x000C(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FSQScoringSetting                      PassengerDelivered;                                // 0x0018(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	float                                         NearObjectiveDistance;                             // 0x0024(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayerMinDistanceTraveled;                         // 0x0028(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQTeamworkSettings) == 0x000004, "Wrong alignment on FSQTeamworkSettings");
static_assert(sizeof(FSQTeamworkSettings) == 0x00002C, "Wrong size on FSQTeamworkSettings");
static_assert(offsetof(FSQTeamworkSettings, PointsForApprovedMarker) == 0x000000, "Member 'FSQTeamworkSettings::PointsForApprovedMarker' has a wrong offset!");
static_assert(offsetof(FSQTeamworkSettings, PointsForSendingTacticalSupport) == 0x00000C, "Member 'FSQTeamworkSettings::PointsForSendingTacticalSupport' has a wrong offset!");
static_assert(offsetof(FSQTeamworkSettings, PassengerDelivered) == 0x000018, "Member 'FSQTeamworkSettings::PassengerDelivered' has a wrong offset!");
static_assert(offsetof(FSQTeamworkSettings, NearObjectiveDistance) == 0x000024, "Member 'FSQTeamworkSettings::NearObjectiveDistance' has a wrong offset!");
static_assert(offsetof(FSQTeamworkSettings, PlayerMinDistanceTraveled) == 0x000028, "Member 'FSQTeamworkSettings::PlayerMinDistanceTraveled' has a wrong offset!");
...
// ScriptStruct Squad.NameTagTargetInfo
// 0x0040 (0x0040 - 0x0000)
struct FNameTagTargetInfo final
{
public:
	class ASQSquadState*                          SquadState;                                        // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   PlayerName;                                        // 0x0008(0x0018)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bIsSL;                                             // 0x0020(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsFireTeamLead;                                   // 0x0021(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_22[0x2];                                       // 0x0022(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         FireTeamIndex;                                     // 0x0024(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsCommander;                                      // 0x0028(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USQRoleSettings*                        CurrentRole;                                       // 0x0030(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USQRoleSettings*                        DeployRole;                                        // 0x0038(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNameTagTargetInfo) == 0x000008, "Wrong alignment on FNameTagTargetInfo");
static_assert(sizeof(FNameTagTargetInfo) == 0x000040, "Wrong size on FNameTagTargetInfo");
static_assert(offsetof(FNameTagTargetInfo, SquadState) == 0x000000, "Member 'FNameTagTargetInfo::SquadState' has a wrong offset!");
static_assert(offsetof(FNameTagTargetInfo, PlayerName) == 0x000008, "Member 'FNameTagTargetInfo::PlayerName' has a wrong offset!");
static_assert(offsetof(FNameTagTargetInfo, bIsSL) == 0x000020, "Member 'FNameTagTargetInfo::bIsSL' has a wrong offset!");
static_assert(offsetof(FNameTagTargetInfo, bIsFireTeamLead) == 0x000021, "Member 'FNameTagTargetInfo::bIsFireTeamLead' has a wrong offset!");
static_assert(offsetof(FNameTagTargetInfo, FireTeamIndex) == 0x000024, "Member 'FNameTagTargetInfo::FireTeamIndex' has a wrong offset!");
static_assert(offsetof(FNameTagTargetInfo, bIsCommander) == 0x000028, "Member 'FNameTagTargetInfo::bIsCommander' has a wrong offset!");
static_assert(offsetof(FNameTagTargetInfo, CurrentRole) == 0x000030, "Member 'FNameTagTargetInfo::CurrentRole' has a wrong offset!");
static_assert(offsetof(FNameTagTargetInfo, DeployRole) == 0x000038, "Member 'FNameTagTargetInfo::DeployRole' has a wrong offset!");
...
// ScriptStruct Squad.SQScoreCalculation
// 0x0008 (0x0008 - 0x0000)
struct FSQScoreCalculation final
{
public:
	ESQCalculationSource                          Source;                                            // 0x0000(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESQScoreType                                  ScoreType;                                         // 0x0001(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESQStatsType                                  StatsType;                                         // 0x0002(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FSQScoreCalculation) == 0x000004, "Wrong alignment on FSQScoreCalculation");
static_assert(sizeof(FSQScoreCalculation) == 0x000008, "Wrong size on FSQScoreCalculation");
static_assert(offsetof(FSQScoreCalculation, Source) == 0x000000, "Member 'FSQScoreCalculation::Source' has a wrong offset!");
static_assert(offsetof(FSQScoreCalculation, ScoreType) == 0x000001, "Member 'FSQScoreCalculation::ScoreType' has a wrong offset!");
static_assert(offsetof(FSQScoreCalculation, StatsType) == 0x000002, "Member 'FSQScoreCalculation::StatsType' has a wrong offset!");
static_assert(offsetof(FSQScoreCalculation, Multiplier) == 0x000004, "Member 'FSQScoreCalculation::Multiplier' has a wrong offset!");

// ScriptStruct Squad.SQPlayerCalloutScore
// 0x0018 (0x0018 - 0x0000)
struct FSQPlayerCalloutScore final
{
public:
	class USQPlayerCallout*                       CalloutRef;                                        // 0x0000(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObject*                                BestState;                                         // 0x0008(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10[0x8];                                       // 0x0010(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQPlayerCalloutScore) == 0x000008, "Wrong alignment on FSQPlayerCalloutScore");
static_assert(sizeof(FSQPlayerCalloutScore) == 0x000018, "Wrong size on FSQPlayerCalloutScore");
static_assert(offsetof(FSQPlayerCalloutScore, CalloutRef) == 0x000000, "Member 'FSQPlayerCalloutScore::CalloutRef' has a wrong offset!");
static_assert(offsetof(FSQPlayerCalloutScore, BestState) == 0x000008, "Member 'FSQPlayerCalloutScore::BestState' has a wrong offset!");
...
public:
	...
	int32                                         NumVehicleKills;                                   // 0x0008(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumDeaths;                                         // 0x000C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumWoundeds;                                       // 0x0010(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumWounds;                                         // 0x0014(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumTeamkills;                                      // 0x0018(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HealPoints;                                        // 0x001C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RevivedPoints;                                     // 0x0020(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TeamWorkScore;                                     // 0x0024(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ObjectiveScore;                                    // 0x0028(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CombatScore;                                       // 0x002C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAdmin;                                            // 0x0030(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDev;                                              // 0x0031(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bQA;                                               // 0x0032(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMember;                                           // 0x0033(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCommander;                                        // 0x0034(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_35[0x3];                                       // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         FireTeamIndex;                                     // 0x0038(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         FireTeamPosition;                                  // 0x003C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PlayerNamePrefix;                                  // 0x0040(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture*                               SupporterPatch;                                    // 0x0050(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture*                               ClanPatch;                                         // 0x0058(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           EquippedItemSkins;                                 // 0x0060(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         ReplicationKey;                                    // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_74[0x4];                                       // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class ASQPlayerState*                         Owner;                                             // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPlayerStateDataObject) == 0x000008, "Wrong alignment on FPlayerStateDataObject");
static_assert(sizeof(FPlayerStateDataObject) == 0x000080, "Wrong size on FPlayerStateDataObject");
...
static_assert(offsetof(FPlayerStateDataObject, NumVehicleKills) == 0x000008, "Member 'FPlayerStateDataObject::NumVehicleKills' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, NumDeaths) == 0x00000C, "Member 'FPlayerStateDataObject::NumDeaths' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, NumWoundeds) == 0x000010, "Member 'FPlayerStateDataObject::NumWoundeds' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, NumWounds) == 0x000014, "Member 'FPlayerStateDataObject::NumWounds' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, NumTeamkills) == 0x000018, "Member 'FPlayerStateDataObject::NumTeamkills' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, HealPoints) == 0x00001C, "Member 'FPlayerStateDataObject::HealPoints' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, RevivedPoints) == 0x000020, "Member 'FPlayerStateDataObject::RevivedPoints' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, TeamWorkScore) == 0x000024, "Member 'FPlayerStateDataObject::TeamWorkScore' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, ObjectiveScore) == 0x000028, "Member 'FPlayerStateDataObject::ObjectiveScore' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, CombatScore) == 0x00002C, "Member 'FPlayerStateDataObject::CombatScore' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, bAdmin) == 0x000030, "Member 'FPlayerStateDataObject::bAdmin' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, bDev) == 0x000031, "Member 'FPlayerStateDataObject::bDev' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, bQA) == 0x000032, "Member 'FPlayerStateDataObject::bQA' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, bMember) == 0x000033, "Member 'FPlayerStateDataObject::bMember' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, bCommander) == 0x000034, "Member 'FPlayerStateDataObject::bCommander' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, FireTeamIndex) == 0x000038, "Member 'FPlayerStateDataObject::FireTeamIndex' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, FireTeamPosition) == 0x00003C, "Member 'FPlayerStateDataObject::FireTeamPosition' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, PlayerNamePrefix) == 0x000040, "Member 'FPlayerStateDataObject::PlayerNamePrefix' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, SupporterPatch) == 0x000050, "Member 'FPlayerStateDataObject::SupporterPatch' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, ClanPatch) == 0x000058, "Member 'FPlayerStateDataObject::ClanPatch' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, EquippedItemSkins) == 0x000060, "Member 'FPlayerStateDataObject::EquippedItemSkins' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, ReplicationKey) == 0x000070, "Member 'FPlayerStateDataObject::ReplicationKey' has a wrong offset!");
static_assert(offsetof(FPlayerStateDataObject, Owner) == 0x000078, "Member 'FPlayerStateDataObject::Owner' has a wrong offset!");
...
// ScriptStruct Squad.SQTimelinePointIndex
// 0x000C (0x000C - 0x0000)
struct FSQTimelinePointIndex final
{
public:
	struct FVector2D                              RealPosition;                                      // 0x0000(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AssignedPointIndex;                                // 0x0008(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQTimelinePointIndex) == 0x000004, "Wrong alignment on FSQTimelinePointIndex");
static_assert(sizeof(FSQTimelinePointIndex) == 0x00000C, "Wrong size on FSQTimelinePointIndex");
static_assert(offsetof(FSQTimelinePointIndex, RealPosition) == 0x000000, "Member 'FSQTimelinePointIndex::RealPosition' has a wrong offset!");
static_assert(offsetof(FSQTimelinePointIndex, AssignedPointIndex) == 0x000008, "Member 'FSQTimelinePointIndex::AssignedPointIndex' has a wrong offset!");
...
// ScriptStruct Squad.SQObjectiveStat
// 0x0020 (0x0020 - 0x0000)
struct alignas(0x08) FSQObjectiveStat final
{
public:
	uint8                                         Pad_0[0x20];                                       // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQObjectiveStat) == 0x000008, "Wrong alignment on FSQObjectiveStat");
static_assert(sizeof(FSQObjectiveStat) == 0x000020, "Wrong size on FSQObjectiveStat");

// ScriptStruct Squad.SQTicketChange
// 0x0014 (0x0014 - 0x0000)
struct FSQTicketChange
{
public:
	...
	uint8                                         TeamId;                                            // 0x0004(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Change;                                            // 0x0008(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TicketsStatus;                                     // 0x000C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESQTicketChangeReason                         Reason;                                            // 0x0010(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQTicketChange) == 0x000004, "Wrong alignment on FSQTicketChange");
static_assert(sizeof(FSQTicketChange) == 0x000014, "Wrong size on FSQTicketChange");
static_assert(offsetof(FSQTicketChange, Timestamp) == 0x000000, "Member 'FSQTicketChange::Timestamp' has a wrong offset!");
static_assert(offsetof(FSQTicketChange, TeamId) == 0x000004, "Member 'FSQTicketChange::TeamId' has a wrong offset!");
static_assert(offsetof(FSQTicketChange, Change) == 0x000008, "Member 'FSQTicketChange::Change' has a wrong offset!");
static_assert(offsetof(FSQTicketChange, TicketsStatus) == 0x00000C, "Member 'FSQTicketChange::TicketsStatus' has a wrong offset!");
static_assert(offsetof(FSQTicketChange, Reason) == 0x000010, "Member 'FSQTicketChange::Reason' has a wrong offset!");

// ScriptStruct Squad.SQTicketChangeLinked
// 0x0004 (0x0018 - 0x0014)
struct FSQTicketChangeLinked final : public FSQTicketChange
{
public:
	int32                                         LinkIndex;                                         // 0x0014(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQTicketChangeLinked) == 0x000004, "Wrong alignment on FSQTicketChangeLinked");
static_assert(sizeof(FSQTicketChangeLinked) == 0x000018, "Wrong size on FSQTicketChangeLinked");
static_assert(offsetof(FSQTicketChangeLinked, LinkIndex) == 0x000014, "Member 'FSQTicketChangeLinked::LinkIndex' has a wrong offset!");

// ScriptStruct Squad.SQLogistcsStat
// 0x000C (0x000C - 0x0000)
struct alignas(0x04) FSQLogistcsStat final
{
public:
	uint8                                         Pad_0[0xC];                                        // 0x0000(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQLogistcsStat) == 0x000004, "Wrong alignment on FSQLogistcsStat");
static_assert(sizeof(FSQLogistcsStat) == 0x00000C, "Wrong size on FSQLogistcsStat");

// ScriptStruct Squad.SQCombatStat
// 0x0038 (0x0038 - 0x0000)
struct alignas(0x08) FSQCombatStat final
{
public:
	uint8                                         Pad_0[0x38];                                       // 0x0000(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQCombatStat) == 0x000008, "Wrong alignment on FSQCombatStat");
static_assert(sizeof(FSQCombatStat) == 0x000038, "Wrong size on FSQCombatStat");

// ScriptStruct Squad.SQVehicleDestroy
// 0x0018 (0x0018 - 0x0000)
struct FSQVehicleDestroy final
{
public:
	class USQVehicleSettings*                     VehicleData;                                       // 0x0000(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         OwningTeam;                                        // 0x0008(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         KillerTeam;                                        // 0x0009(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A[0x2];                                        // 0x000A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         KillerPlayer;                                      // 0x000C(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         HistoryIndex;                                      // 0x0010(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQVehicleDestroy) == 0x000008, "Wrong alignment on FSQVehicleDestroy");
static_assert(sizeof(FSQVehicleDestroy) == 0x000018, "Wrong size on FSQVehicleDestroy");
static_assert(offsetof(FSQVehicleDestroy, VehicleData) == 0x000000, "Member 'FSQVehicleDestroy::VehicleData' has a wrong offset!");
static_assert(offsetof(FSQVehicleDestroy, OwningTeam) == 0x000008, "Member 'FSQVehicleDestroy::OwningTeam' has a wrong offset!");
static_assert(offsetof(FSQVehicleDestroy, KillerTeam) == 0x000009, "Member 'FSQVehicleDestroy::KillerTeam' has a wrong offset!");
static_assert(offsetof(FSQVehicleDestroy, KillerPlayer) == 0x00000C, "Member 'FSQVehicleDestroy::KillerPlayer' has a wrong offset!");
static_assert(offsetof(FSQVehicleDestroy, HistoryIndex) == 0x000010, "Member 'FSQVehicleDestroy::HistoryIndex' has a wrong offset!");

// ScriptStruct Squad.SQTicketsSummaryData
// 0x0040 (0x0040 - 0x0000)
struct FSQTicketsSummaryData final
{
public:
	int32                                         StartTickets;                                      // 0x0000(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         EndTickets;                                        // 0x0004(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FSQTicketsSummaryRecord>        TicketsRecords;                                    // 0x0008(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FSQTicketsSummaryVehicleRecord> VehicleRecords;                                    // 0x0018(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         AmmoSupplied;                                      // 0x0028(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ConstructionSupplied;                              // 0x002C(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSQTicketsSummaryRecord                FOBCreated;                                        // 0x0030(0x000C)(BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQTicketsSummaryData) == 0x000008, "Wrong alignment on FSQTicketsSummaryData");
static_assert(sizeof(FSQTicketsSummaryData) == 0x000040, "Wrong size on FSQTicketsSummaryData");
static_assert(offsetof(FSQTicketsSummaryData, StartTickets) == 0x000000, "Member 'FSQTicketsSummaryData::StartTickets' has a wrong offset!");
static_assert(offsetof(FSQTicketsSummaryData, EndTickets) == 0x000004, "Member 'FSQTicketsSummaryData::EndTickets' has a wrong offset!");
static_assert(offsetof(FSQTicketsSummaryData, TicketsRecords) == 0x000008, "Member 'FSQTicketsSummaryData::TicketsRecords' has a wrong offset!");
static_assert(offsetof(FSQTicketsSummaryData, VehicleRecords) == 0x000018, "Member 'FSQTicketsSummaryData::VehicleRecords' has a wrong offset!");
static_assert(offsetof(FSQTicketsSummaryData, AmmoSupplied) == 0x000028, "Member 'FSQTicketsSummaryData::AmmoSupplied' has a wrong offset!");
static_assert(offsetof(FSQTicketsSummaryData, ConstructionSupplied) == 0x00002C, "Member 'FSQTicketsSummaryData::ConstructionSupplied' has a wrong offset!");
static_assert(offsetof(FSQTicketsSummaryData, FOBCreated) == 0x000030, "Member 'FSQTicketsSummaryData::FOBCreated' has a wrong offset!");
...
public:
	...
	ESQScoreType                                  ScoreGroup;                                        // 0x0018(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Timestamp;                                         // 0x001C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQScoreEvent) == 0x000008, "Wrong alignment on FSQScoreEvent");
static_assert(sizeof(FSQScoreEvent) == 0x000020, "Wrong size on FSQScoreEvent");
...
static_assert(offsetof(FSQScoreEvent, Timestamp) == 0x00001C, "Member 'FSQScoreEvent::Timestamp' has a wrong offset!");
